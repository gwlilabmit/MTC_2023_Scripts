...
Raw_Data_Location="/home/mirae/data/Sequencing/230117Li/Snapshot_Bowtie_Not_Strict/Raw_Reads/" #Folder where the raw data lives.
Save_Folder_Location="/home/mirae/data/Sequencing/230117Li/Snapshot_Bowtie_Not_Strict/" #Folder for where to store all intermediary files.
