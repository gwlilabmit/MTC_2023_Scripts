...
Raw_Data_Location="/home/mirae/data/Sequencing/230117Li/Snapshot_Experiment/Raw_Reads/" #Folder where the raw data lives.
Save_Folder_Location="/home/mirae/data/Sequencing/230117Li/Snapshot_Experiment/" #Folder for where to store all intermediary files.
