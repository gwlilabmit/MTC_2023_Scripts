...
Raw_Data_Location="/home/mirae/data/MTC_Publication_Data/210809Li/raw_fastq_files/" #Folder where the raw data lives.
Save_Folder_Location="/home/mirae/data/MTC_Publication_Data/210809Li/" #Folder for where to store all intermediary files.
Bowtie_Args="-k 1 -v 2"
Preprocess_File="/home/mirae/data/Publication_Raw_Data_Processing/preprocessing_scripts/210809Li_preprocess.sh"
Original_End=".fastq"
Reversed="false"
...
Trim_Save=${Save_Folder_Location}trimmed_reads/
